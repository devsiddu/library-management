        ...
        <div class="main">
            ...
            <div class="container">
                ...
                if (isset($_POST["stud_search"])) {
                    ...
                    $query = "SELECT * FROM `books`,`students` WHERE book_no=$book_no AND usn='$usn'";
                ...
                if (isset($_POST["issue_book"])) {
                    ...
                    $query = "INSERT INTO `issued_books` (`id`, `book_no`, `bookname`, `usn`, `name`, `issue_date`, `return_date`, `status`) VALUES ('', $book_no, '$bookname', '$usn', '$studname', '$issudate', '$returndate', '$status');";
                    $query_run = mysqli_query($connection, $query);
                    ...
                    <form action="" method="post">
                        <div class="user-details">
                            ...
                            <div class='input-box'>
                                ...
                                <input type='text' name='issuedate' value='<?php echo date("Y-m-d"); ?>' required>
                            </div>
                            <div class='input-box'>
                                <span class='details'>Return Date</span>
                                <input type='text' name='returndate'
                                    value='<?php echo date('Y-m-d', strtotime("+7 day")); ?>' readonly required>
                            </div>
